...
public final class SearchBinding implements ViewBinding {
  ...
  @NonNull
  public final Button cmdOK;

  @NonNull
  public final ListView lstDevices;

  private SearchBinding(@NonNull LinearLayout rootView, @NonNull Button cmdOK,
      @NonNull ListView lstDevices) {
  ...
  public static SearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cmdOK;
      Button cmdOK = ViewBindings.findChildViewById(rootView, id);
      if (cmdOK == null) {
        break missingId;
      }

      id = R.id.lstDevices;
      ListView lstDevices = ViewBindings.findChildViewById(rootView, id);
      if (lstDevices == null) {
        break missingId;
      }

      return new SearchBinding((LinearLayout) rootView, cmdOK, lstDevices);
    }
