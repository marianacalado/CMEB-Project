...
"""
        ...
        x = Double.parseDouble((x + dataX));
        y = Double.parseDouble((y +dataY));
        z = (z + dataZ);
        ...
        //convert to double
        //dataX = Double.valueOf(dataX);
        //dataY = Double.valueOf(dataX);
        //dataZ = Double.valueOf(dataX);
        ...
        double Magnitude = Math.sqrt(dataX*dataX + dataY*dataY + dataZ*dataZ);
